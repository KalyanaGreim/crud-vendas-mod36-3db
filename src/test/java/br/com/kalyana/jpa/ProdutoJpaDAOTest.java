...
import br.com.kalyana.dao.jpa.IProdutoJpaDAO;
import br.com.kalyana.dao.jpa.ProdutoJpaDAO;
...
public class ProdutoJpaDAOTest {
    ...
    public void alterarCliente() throws TipoChaveNaoEncontradaException, DAOException, MaisDeUmRegistroException, TableException {
        ...
        produto.setNome("Kaly Greim");
        produtoDao.alterar(produto);
        ProdutoJpa produtoBD = this.produtoDao.consultar(produto.getId());
        assertNotNull(produtoBD);
        Assert.assertEquals("Kaly Greim", produtoBD.getNome());
    }
